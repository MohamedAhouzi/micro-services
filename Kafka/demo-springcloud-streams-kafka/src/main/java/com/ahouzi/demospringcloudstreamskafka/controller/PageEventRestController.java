package com.ahouzi.demospringcloudstreamskafka.controller;

import com.ahouzi.demospringcloudstreamskafka.entities.PageEvent;
    ...
    public Flux<Map<String, Long>> analytics() {
        return Flux.interval(Duration.ofSeconds(1))
                .map(sequence -> {
                    ...
                    Instant from = now.minusMillis(1000);
