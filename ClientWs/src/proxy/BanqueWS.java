 ...
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8086/BanqueWS?wsdl")
public class BanqueWS
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8086/BanqueWS?wsdl");
